    ...
    <>
      ...
      >
        ...
        <div className="product-info">
          <div className="product-cat" style={{ textTransform: 'uppercase', fontSize: '10px', letterSpacing: '1px', marginBottom: '8px' }}>{product.brand || t('nav_categories')}</div>
          <Link to={`/product/${product.id}`}>
            <h3 className="product-title-text" style={{ 
              fontSize: '16px', 
              fontWeight: 700, 
              margin: '0 0 12px 0',
              display: '-webkit-box',
