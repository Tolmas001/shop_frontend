...
const translations = {
  uz: {
    ...
    menu: 'Menyu', language: 'Til', account: 'Hisob', phone: 'Telefon', cancel: 'Bekor qilish',
    link_copied: 'Havola nusxalandi', login_success: 'Muvaffaqiyatli kirdingiz!',
    ...
    status_pending: 'Kutilmoqda', status_processing: 'Tayyorlanmoqda', status_shipped: 'Yo\'lda', status_delivered: 'Yetkazildi', status_completed: 'Tugallangan', status_cancelled: 'Bekor qilingan',
    confirm_cancel_order: 'Buyurtmani bekor qilmoqchimisiz?', cancel_order: 'Buyurtmani bekor qilish',
  ...
  ru: {
    ...
    menu: 'Меню', language: 'Язык', account: 'Аккаунт', phone: 'Телефон', cancel: 'Отмена',
    link_copied: 'Ссылка скопирована', login_success: 'Вы успешно вошли!',
    ...
    status_pending: 'В ожидании', status_processing: 'Готовится', status_shipped: 'В пути', status_delivered: 'Доставлен', status_completed: 'Завершен', status_cancelled: 'Отменен',
    confirm_cancel_order: 'Отменить заказ?', cancel_order: 'Отменить заказ',
  ...
  en: {
    ...
    menu: 'Menu', language: 'Language', account: 'Account', phone: 'Phone', cancel: 'Cancel',
    link_copied: 'Link copied', login_success: 'Logged in successfully!',
    ...
    status_pending: 'Pending', status_processing: 'Processing', status_shipped: 'Shipped', status_delivered: 'Delivered', status_completed: 'Completed', status_cancelled: 'Cancelled',
    confirm_cancel_order: 'Cancel this order?', cancel_order: 'Cancel order',
